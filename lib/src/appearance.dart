...
class CircularSliderAppearance {
  ...
  TextStyle get infoMainLabelStyle {
    ...
    return TextStyle(fontWeight: FontWeight.w100, fontSize: size / 5.0, color: Color.fromRGBO(30, 0, 59, 1.0));
  }

  TextStyle get infoTopLabelStyle {
    if (_topLabelStyle != null) return _topLabelStyle;
    return TextStyle(fontWeight: FontWeight.w600, fontSize: size / 10.0, color: Color.fromRGBO(147, 81, 120, 1.0));
  }
...
class CustomSliderColors {
  ...
  Color progressBarColor; // No longer final so can be changed in circular_slider.dart
